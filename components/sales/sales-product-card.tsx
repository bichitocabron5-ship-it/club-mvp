  ...
  return (
    ...
    >
      <div className="min-w-0">
        <div className="break-words text-lg font-black leading-tight">
      ...
      <div className="mt-4 flex min-h-11 items-center justify-center rounded-xl bg-[#0b0b0c] px-3 py-2.5 text-center text-sm font-bold text-white">
